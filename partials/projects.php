<div class="section" id="section4">
  <div class="section-content">
    ...
    <div class="content-right">
      ...
      <p class="mb-5">A selection of projects I’ve worked on through Zeno and my own freelance work.</p>

      <!-- Project: Website Zoë van Ree -->
      ...
      <!-- Project: Gerard de Nijs -->
      <h4 class="mt-4">Zeno | Gerard de Nijs</h4>
      ...
      <!-- Project: Outdoorplanners -->
      <h4 class="mt-4">Zeno | Outdoorplanners</h4>
      ...
      <!-- Project: TripLink -->
      <div class="triplink">
        <div class="triplink-intro">
          <h4 class="mt-4">Bootcamp | TripLink</h4>
          <p class="mb-3">Final project of the Le Wagon bootcamp. A mobile app called TripLink, a platform on
            which
        ...
        <div class="triplink-container">
          <div class="triplink-container-left">
            <div class="triplink-container-left-phones">
              <img src="images/triplink-home.png" alt="TripLink" class="triplink-phone">
              <img src="images/triplink-guide.png" alt="TripLink" class="triplink-phone">
            </div>
          </div>
          <div class="triplink-container-right">
            <div class="triplink-container-right-phones">
              <img src="images/triplink-connect.png" alt="TripLink" class="triplink-phone">
              <img src="images/triplink-chat.png" alt="TripLink" class="triplink-phone">
            </div>
          </div>
        </div>
      </div>
